...
function Users() {
  ...
  function getUsers() {
    ...
    fetch(
      'https://console.gateway.senslabs.io/api/users/list?matcher=DEFAULT',
      {
        // fetch(
        // 'https://console.gateway.senslabs.io/api/users/list?organizationId=e74ec188-e3db-48bb-b521-70c9e53312c6&matcher=DEFAULT',{
        method: 'GET',
        headers: {
      ...
      .then((res) => {
        ...
        //   (user) => new Date(user.DateOfBirth).getYear() > 70
        // ); //only for this demo
  ...
  function generateRows(user) {
    return users.map((user) => {
      ...
      return (
        <div className='' key={user.UserId} style={row_style}>
